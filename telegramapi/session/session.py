...
import telegramapi
from telegramapi import raw, utils
from telegramapi.connection import Connection
from telegramapi.crypto import mtproto
...
from telegramapi.raw.core import FutureSalts, Int, MsgContainer, TLObject
...
class Session:
    ...
    async def start(self):
        ...
        try:
            ...
            log.info(
                "Session initialized: Pyrogram v%s (Layer %s)", telegramapi.__version__, layer
            )
