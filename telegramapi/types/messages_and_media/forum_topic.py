...
import telegramapi
from telegramapi import types, raw, utils
...
class ForumTopic(Object):
    ...
    @staticmethod
    def _parse(client: "telegramapi.Client", forum_topic: "raw.types.ForumTopic", messages: dict = {},  users: dict = {}, chats: dict = {}) -> "ForumTopic":
        if not forum_topic:
            return None
