...
import telegramapi
from telegramapi import enums, raw, types, utils
from telegramapi.errors import ChannelForumMissing, ChannelPrivate, ChannelInvalid, MessageIdsEmpty, PeerIdInvalid, ChatAdminRequired
from telegramapi.parser import Parser
from telegramapi.parser import utils as parser_utils
...
class Message(Object, Update):
    ...
    def __init__(
        self,
        *,
        client: "telegramapi.Client" = None,
        id: int,
