...
from telegramapi.file_id import FileType
...
class InputChatPhoto(Object):
    ...
    async def write(self, client: "telegramapi.Client") -> "raw.base.InputFile":
...
class InputChatPhotoPrevious(InputChatPhoto):
    ...
    async def write(self, client: "telegramapi.Client") -> "raw.types.InputPhoto":
