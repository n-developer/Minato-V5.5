...
import telegramapi
from telegramapi import __license__, __version__, enums, raw, utils
from telegramapi.crypto import aes
from telegramapi.errors import (
    AuthBytesInvalid,
    BadRequest,
    CDNFileHashMismatch,
    ChannelPrivate,
...
from telegramapi.handlers.handler import Handler
from telegramapi.methods import Methods
from telegramapi.qrlogin import QRLogin
from telegramapi.session import Auth, Session
from telegramapi.storage import SQLiteStorage, Storage
from telegramapi.types import LinkPreviewOptions, TermsOfService, User
from telegramapi.utils import ainput
...
class Client(Methods):
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except telegramapi.StopTransmission:
                raise
