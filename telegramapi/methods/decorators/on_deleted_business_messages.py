...
import telegramapi
from telegramapi.filters import Filter
...
class OnDeletedBusinessMessages:
    def on_deleted_business_messages(
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telegramapi.Client):
                self.add_handler(telegramapi.handlers.DeletedBusinessMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telegramapi.handlers.DeletedBusinessMessagesHandler(func, self),
