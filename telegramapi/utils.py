...
import telegramapi
from telegramapi import enums, raw, types
from telegramapi.file_id import DOCUMENT_TYPES, PHOTO_TYPES, FileId, FileType
from telegramapi.types.messages_and_media.message import Str
...
async def get_input_stargift(client: "telegramapi.Client", owned_gift_id: str) -> "raw.base.InputSavedStarGift":
